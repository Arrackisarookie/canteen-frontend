...
export default {
  ...
  data() {
    return {
      ...
      websocket_protocol: import.meta.env.VITE_WEBSOCKET_PROTOCOL
    }
  },
  methods: {
    init_chat() {
      ...
      var sockets_bay_url = this.websocket_protocol + `://` + this.backend_baseurl + `/chatroom?nickname=` + this.nickname;
